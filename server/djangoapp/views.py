...
def get_dealer_details(request, dealer_id):
    context = {}
    if request.method == "GET":
        url = 'https://manassics-5000.theiadocker-3-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai//api/review'
...
def add_review(request, dealer_id):
    ...
    if request.user.is_authenticated:
        ...
        if request.method == "GET":
            url = "https://manassics-5000.theiadocker-3-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai//api/review?id={dealer_id}"
        ...
        if request.method == "POST":
            ...
            url = "https://manassics-5000.theiadocker-3-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai//api/review"  # API Cloud Function route
